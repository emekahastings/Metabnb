...
<div className='tag'>
            ...
            <img src={cancel} className='x' alt='' />
                ...
                <div className='oya'>
                <input type={'text'} placeholder='Metamask' className='meta'/> 
                <img src={mask} className='mask' aria-readonly alt='' /> < br />
                </div> 
                <div className='oya'>
                <input type={'text'} placeholder='Wallet' className='meta'/> 
                <img src={wallet} className='mask' aria-readonly alt='' />
                </div>
            </div>
